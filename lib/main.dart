...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = kasapooleFirebaseUserStream()
      ..listen((user) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        unselectedItemColor: Color(0xFF858080),
        selectedBackgroundColor: Color(0x00000000),
        borderRadius: 20.0,
        itemBorderRadius: 8.0,
        margin: EdgeInsetsDirectional.fromSTEB(25.0, 0.0, 25.0, 15.0),
          ...
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  Icons.home,
                  color: currentIndex == 0 ? Colors.black : Color(0xFF858080),
                  size: 24.0,
                ),
                Text(
                  'Home',
            ...
            customWidget: Column(
              ...
              children: [
                Icon(
                  ...
                  color: currentIndex == 1 ? Colors.black : Color(0xFF858080),
                  size: 24.0,
                ),
                Text(
                  'Translate',
